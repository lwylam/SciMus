...
void ReverseBricksTraj(dynamixel::GroupSyncRead groupSyncRead, bool showAttention = false);
...
void ReverseBricksTraj(dynamixel::GroupSyncRead groupSyncRead, bool showAttention){
...
int32_t ToMotorCmd(int motorID, double length){ // applicable for all 12 motors
    double scale = 509295.818; //509295.818; // 6400 encoder count per revoltion, 40 times gearbox, 50mm spool radias. ie 6400*25/(2*pi*0.05) 
    if(motorID >= NodeNum) {
